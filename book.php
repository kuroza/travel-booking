...
?>
      ...
      <main>
         <div class="wrapper">
            <?php
               global $db;
               //fix the Undefined index: pid
               $query = "SELECT * FROM package WHERE packid='" . $_GET["pid"] ."'";
            ...
            <section class="section-right">
               <form class="enquiry-form" action="book.php" method="post">
                  ...
                  <ul>
                     ...
                     <li>Package prices: <strong>B$<?php echo $data[3]; ?> (Adult) | B$<?php echo $data[4]; ?> (Child – Age 3 to 11 years old)</strong></li>
                  </ul>
